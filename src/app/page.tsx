...
export default async function HomePage() {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-oslo-blue via-pool-deep to-summer-turquoise px-4 py-16 text-white sm:px-6 sm:py-20">
        <div className="pointer-events-none absolute -right-6 top-6 h-32 w-32 rounded-full bg-pool-sky/40" />
        <div className="pointer-events-none absolute bottom-8 left-8 h-24 w-24 rounded-full bg-summer-sun/50" />

        <div className="relative mx-auto max-w-4xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-summer-sun px-4 py-1.5 text-sm font-bold text-oslo-ink">
          ...
          <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
            <Link
              href="/kart"
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-summer-sun px-8 py-4 text-base font-bold text-oslo-ink transition hover:bg-summer-lime"
            >
